...
public class AugmentedImageFragment extends ArFragment {
  ...
  private static final String SAMPLE_IMAGE_DATABASE = "190905" + "_database.imgdb";
  ...
  public void onAttach(Context context) {
    ...
    Log.i(getString(R.string.AugmentedImageFragment),"onAttach");
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    Log.i(getString(R.string.AugmentedImageFragment),"onCreateView");
  ...
  protected Config getSessionConfiguration(Session session) {
    ...
    Log.i(getString(R.string.AugmentedImageFragment),"getSessionConfiguration");
  ...
  private boolean setupAugmentedImageDatabase(Config config, Session session) {
    Log.i(getString(R.string.AugmentedImageFragment),"setupAugmentedImageDatabase");
  ...
  private Bitmap loadAugmentedImageBitmap(AssetManager assetManager) {
    Log.i(getString(R.string.AugmentedImageFragment),"loadAugmentedImageBitmap");
