...
//            View snackbarView = messageSnackbar.getView();
//              ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(snackbarView.getLayoutParams().width, 30);
//              Log.e("Save", "layoutParams Width :  " + Integer.toString(layoutParams.width) + " / Height : " + Integer.toString(layoutParams.height));
